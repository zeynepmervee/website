...
if(is_file("deneme")) //true geri dönerse dosyadır
	...
	echo "deneme dizindir yani klasördür<br/>";
...
$liste=glob("*.php"); //.php ile biten
echo "<pre>";
print_r($liste);
echo "</pre>";
echo "<br/><br/>";
$liste2=glob("*.*"); //içinde . geçen
echo "<pre>";
print_r($liste2);
echo "</pre>";
mkdir("silinecek_klasor"); //oluşturdu
rmdir("silinecek_klasor"); //sildi
