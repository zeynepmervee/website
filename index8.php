...
print_r($isim);
echo '</pre>';
$isim=array_pad($isim,50,"Mehmet"); //dizi uzunuluğu 50 olacak şekilde sona  değer eklenir
echo '<pre>';
print_r($isim);
echo '</pre>';

$kusisimleri=array(1=>"Çaylak",2=>"Kerkenez",3=>"Kartal",4=>"Doğan");
$kusisimleri=array_pad($kusisimleri,-8,"Şahin"); //dizi uzunuluğu 8 olacak şekilde başa değer eklenir
echo '<pre>';
print_r($kusisimleri);
echo '</pre>';
...
$balıkisimleri=array_pad($balıkisimleri,5,"Palamut"); //mevcut dizi uzunluğundan küçük, değişiklik yapılmaz
echo '<pre>';
...
$derskitap2=array_slice($derskitap,2,2);//baştan 2 tane sil,2 tane ilerle ve yaz
echo '<pre>';
print_r($derskitap2);
echo '</pre>';
...
print_r($adlar);
echo '</pre>';
echo "array sliceeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee<br>";
...
$kitaplar2=array(1=>"PHP",2=>"C++",3=>"Java");
$sonuc=array_diff_assoc($kitaplar,$kitaplar2);
echo '<pre>';
print_r($sonuc);
echo '</pre>';

$kitaplar3=array(0=>"PHP",1=>"Java",2=>"C++",3=>"Web Tasarım");
$sonuc=array_diff_assoc($kitaplar2,$kitaplar3);//solda yazandaki farkları yazıyor sadece key ile birlikte
echo '<pre>';
print_r($sonuc);
echo '</pre>';
...
$kitaplar=array_merge($kitaplar,array_fill(2,5,"Android"));
echo '<pre>';
print_r($kitaplar);
echo '</pre>';
...
//print_r(array_rand($sayisaldizi,3));
?>
